...
class ChapteraiQuizForm(forms.ModelForm):
    class Meta:
        model = Quiz
        fields = ['resource', 'chapter']

    def save(self, commit=True):
        instance = super().save(commit=False)
        instance.questions = generate_quiz_questions(instance.chapter.title, instance.chapter.content)
        if commit:
            instance.save()
        return instance
